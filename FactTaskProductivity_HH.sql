...
--where-- /* epistatus = 'CURRENT' and */ episodeEndDate < skScheduleDateKey and --CAST(GETDATE() AS date) and
--where EpisodeStartDate = '20251120' 
--ScheduledVisitId LIKE 12807386
--WHERE EpisodeID LIKE 855125
--WHERE OpenClosedFlag = 'Open'
--AND OpenClosedFlag = 'Closed'
--AND VisitBetweenSOEandEOE = 1
--AND MissedVisit = 1
--AND DischargeTasks = 1
--AND NVDC = 1
--AND CompletedVisits = 1
--AND OpenClosedFlag = 'Closed'
--WHERE EpisodeID LIKE 870781   --Good Example, how should we be counting these late visits in the past?
--WHERE EpisodeID LIKE 886498
--WHERE EpisodeID LIKE 842845
--AND TaskCode = 'SN11'
--882597 --650482 --897747 --885222 
--WHERE InHomeVisits_VisitNumber != InHomeVisits_VisitNumber_2
--AND taskCode LIKE '%PRN%' */
--AND VisitBetweenSOEandEOE = 0
--AND TaskStatus NOT IN ( 'Completed', 'Missed' )
--WHERE TaskStatus = 'Incomplete'
--WHERE InsuranceID = 28953
--WHERE EpisodeID = 861779
--WHERE PatientName LIKE 'CHERIAN, MATHEW'
--AND skScheduleDateKey BETWEEN '20250501' AND '20250531'
--AND episodeEndDate BETWEEN '20250501' AND '20250531'
--AND billingPeriodEndDate BETWEEN '20250601' AND '20250630'
and (
